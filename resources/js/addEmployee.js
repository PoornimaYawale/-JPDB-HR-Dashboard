...
function resetForm()
{
    ...
    var getCurrRequest = createGET_BY_RECORDRequest(conntoken, userDBName, empRelationName, getCurrRecNoFromLS());
...
function getEmpFromEmpId()
{
    ...
    var getRequest = createGET_BY_KEYRequest(conntoken, userDBName, empRelationName, empIdJsonObj);
    jQuery.ajaxSetup({async: false});
...
function firstData()
{
    var getFirstRequest = createFIRST_RECORDRequest(conntoken, userDBName, empRelationName);
    jQuery.ajaxSetup({async: false});
...
function prevData()
{
    ...
    var getPrevRequest = createPREV_RECORDRequest(conntoken, userDBName, empRelationName, r);
    jQuery.ajaxSetup({async: false});
...
function nextData()
{
    ...
    var getNextRequest = createNEXT_RECORDRequest(conntoken, userDBName, empRelationName, r);
    jQuery.ajaxSetup({async: false});
...
function lastData()
{
    var getLastRequest = createLAST_RECORDRequest(conntoken, userDBName, empRelationName);
    jQuery.ajaxSetup({async: false});
...
function saveData()
{
   ...
   var putRequest =  createPUTRequest(conntoken, jsonStrObj, userDBName, empRelationName);
   jQuery.ajaxSetup({async:false});
...
function changeData()
{
    ...
    var updateRequest = createUPDATERecordRequest(conntoken, jsonChg, userDBName, empRelationName, getCurrRecNoFromLS());
    jQuery.ajaxSetup({async: false});
